...
export type ImageDescriptorConstructorDefaultValues = Required<Pick<ImageDescriptorConstructor,
    'imageSeparator' |
    'imageLeftPosition' |
    'imageTopPosition' |
    'interlanceFlag' |
...
export class ImageDescriptor implements BytesEncoder {
    ...
    constructor(props: ImageDescriptorConstructor) {
        ...
        this.imageSeparator = props.imageSeparator ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.imageSeparator;
        this.imageLeftPosition = props.imageLeftPosition ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.imageLeftPosition;
        this.imageTopPosition = props.imageTopPosition ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.imageTopPosition;
        this.localColorTableFlag = props.localColorTableFlag ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.localColorTableFlag;
        this.interlanceFlag = props.interlanceFlag ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.interlanceFlag;
        this.sortFlag = props.sortFlag ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.sortFlag;
        this.sizeOfLocalColorTable = props.sizeOfLocalColorTable ?? IMAGE_DESCRIPTOR_DEFAULT_VALUES.sizeOfLocalColorTable;
    }
